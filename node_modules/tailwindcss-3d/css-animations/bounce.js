...
var Bounce = function Bounce() {
    ...
    this.keyframes = function(param) {
        ...
        return _lodash.default.chain(values).transform((0, _lodashTransformers.axesModifier)(), {}).transform((0, _lodashTransformers.nameModifier)("bounce"), {}).transform((0, _lodashTransformers.signModifier)(), {}).mapValues(function(param) {
    ...
    this.animation = function(param) {
        var theme = param.theme;
        var values = _this.normaliseValues(theme("bounce"));
        return _lodash.default.chain(values).transform((0, _lodashTransformers.axesModifier)(), {}).transform((0, _lodashTransformers.nameModifier)("bounce"), {}).transform((0, _lodashTransformers.signModifier)(), {}).mapValues(function(param, modifier) {
